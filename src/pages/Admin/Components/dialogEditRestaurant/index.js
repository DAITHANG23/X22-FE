  ...
  useEffect(() => {
    const fetchRestaurantDetails = async () => {
      try {
        ...
        setTimeStart(response.restaurant.timeStart);
        setTimeEnd(response.restaurant.timeEnd);
        setPhoneNumber(response.restaurant.phoneNumber);
        setAddress(response.restaurant.address);
        setMinPrice(response.restaurant.minPrice);
        setMaxPrice(response.restaurant.maxPrice);
        setType(response.restaurant.type);
        setDescription(response.restaurant.description);
        setImages(response.restaurant.images);
